...
const OSIFlow = dynamic(() => import('@/components/OSIFlow'), { suspense: true });
const CommandSuggestor = dynamic(() => import('@/components/CommandSuggestor'), { suspense: true });
const TicketNoteGenerator = dynamic(() => import('@/components/TicketNoteGenerator'), { suspense: true });
const PlaybookChecklist = dynamic(() => import('@/components/PlaybookChecklist'), { suspense: true });
const KnowledgeBase = dynamic(() => import('@/components/KnowledgeBase'), { suspense: true });
const ScriptVault = dynamic(() => import('@/app/script_vault(15)'), { suspense: true });
const TroubleshootingTool = dynamic(() => import('@/app/threaded_troubleshooting_logs'), { suspense: true });
const CommandSimulator = dynamic(() => import('@/app/command_simulator'), { suspense: true });
const AuditLogViewer = dynamic(() => import('@/app/audit_log_viewer_panel'), { suspense: true });
const HelpdeskIntegrationPanel = dynamic(() => import('@/app/helpdesk_integration_panel'), { suspense: true });
const IntegrationTokenManager = dynamic(() => import('@/app/integration_token_manager'), { suspense: true });
