...
function MainComponent() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" aria-label="Admin feature navigation">
        <Link href="/admin/analytics-dashboard" className="p-4 bg-white rounded shadow hover:bg-gray-50">Analytics Dashboard</Link>
        <Link href="/api/admin/openai-key" className="p-4 bg-white rounded shadow hover:bg-gray-50">Integration Token Manager</Link>
        <Link href="/admin/audit-log-viewer" className="p-4 bg-white rounded shadow hover:bg-gray-50">Audit Log Viewer</Link>
        <Link href="/admin/helpdesk-integration" className="p-4 bg-white rounded shadow hover:bg-gray-50">Helpdesk Integrations</Link>
        <Link href="/admin/add-on-purchases" className="p-4 bg-white rounded shadow hover:bg-gray-50">Add-On Purchases</Link>
        <Link href="/admin/blog-content" className="p-4 bg-white rounded shadow hover:bg-gray-50">Blog Content Engine</Link>
        <Link href="/admin/data-export" className="p-4 bg-white rounded shadow hover:bg-gray-50">Data Export Panel</Link>
        <Link href="/admin/feedback-collector" className="p-4 bg-white rounded shadow hover:bg-gray-50">Feedback Collector</Link>
        <Link href="/admin/task-runner" className="p-4 bg-white rounded shadow hover:bg-gray-50">Task Runner & Scheduler</Link>
        <Link href="/admin/upsell-tools" className="p-4 bg-white rounded shadow hover:bg-gray-50">Upsell & Free Trials</Link>
      </div>
